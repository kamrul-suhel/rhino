...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" width="518">
            <h1 style="font-weight: normal; font-size: 30px; margin-top: 0; color: #007bcd">{{ $trans['greatNews'] }}<br/>{{ $trans['youHaveBennInvitedToJoinOur'] ?? 'You have been invited to join our' }} {{ $guest->event_name }}</h1>

            <p>{{ $trans['dear'] ?? 'Dear' }} {{ $guest->title }} {{ $guest->surname }},</p>
